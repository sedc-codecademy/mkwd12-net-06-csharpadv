...
* **Track**
  ...
  * Should open a list of activities available for tracking
    ...
    * Other Hobbies
      * Extra Info: Name of hobby <br><br>

  * ***How is the tracking done ? (explanation)***
    ...
    * Each activity is tracked separately for each user <br><br>
